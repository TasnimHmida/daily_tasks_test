...
//         .order('created_at')
//         .map((maps) => maps
//             .map((map) => MessageModel.fromJson(myUserId: myUserId, json: map))
//             .toList());
//     super.initState();
//   }
//
...
//     }
//     final data =
//         await supabase.from('members').select().eq('user_id', profileId).single();
...
//       ),
//       const SizedBox(width: 12),
//       Text(format(message.createdAt ?? DateTime.now(), locale: 'en_short')),
